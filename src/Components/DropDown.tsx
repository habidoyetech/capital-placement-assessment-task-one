...
const DropDown: React.FC<DropDownProps> = ({question, choicesList, otherOption, setChoiceList}) => {
  ...
  return (
    <>
        ...
        <Checkbox onChange={onChangeCheckbox} checked={otherOption} className='text-[12px] mb-6'>Enable "Other" option</Checkbox>
